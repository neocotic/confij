(function() {
  ...
  DefaultAdapter = (function(_super) {
    ...
    DefaultAdapter.prototype.loadSync = function() {
      return this.confij.parseSync(this.target);
    };
    ...
    DefaultAdapter.prototype.saveSync = function(data) {
      return this.confij.stringifySync(data);
    };
