(function() {
  ...
  FsAdapter = (function(_super) {
    ...
    FsAdapter.prototype.loadSync = function() {
      var buffer;
      buffer = Fs.readFileSync(this.target, this.option('loadSync', 'encoding'));
      return this.confij.parseSync(buffer.toString());
    };
    ...
    FsAdapter.prototype.saveSync = function(data) {
      var buffer;
      buffer = this.confij.stringifySync(data);
      Fs.writeFileSync(this.target, buffer, this.option('saveSync', 'encoding'));
      return buffer;
    };
